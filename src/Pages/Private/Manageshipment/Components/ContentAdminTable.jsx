...
const tempData = [
  {
    ...
    correoCliente: "cliente123@ads.com",
    fechaDeseadaEntrega: "05/05/2025",
    estado: "Entregado",
  },
  {
    id: 2,
    ...
    <>
      ...
      >
        <TableHeader>
          ...
          <TableColumn className="w-[156px]">Fecha de entrega</TableColumn>
          <TableColumn className="w-[156px]">Correo cliente</TableColumn>
        ...
        >
          {(item) => (
            <TableRow key={`${item.id}-${Math.random()}`}>
              ...
              <TableCell>{item?.fechaDeseadaEntrega}</TableCell>
              <TableCell>{item?.correoCliente}</TableCell>
